...
The API & Worker (Backend - C++): * api_server.cpp: Handles CORS, REST HTTP methods (GET, POST, DELETE), and serves database queries to the frontend.
...
The Dashboard (Frontend - React): * A Vite-powered React application that acts as the control center, communicating with the C++ API.
